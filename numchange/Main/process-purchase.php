...
$query="insert into register (Customer_Name,Requested_Number,reg_medium,Location,date,time,status,operator,Address,NIN,receipt_no,sales_channel, nationality, DOB) 
