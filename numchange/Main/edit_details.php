...
<title>Qcell Edit Purchased Details Form</title>
...
<br/>
<br/>
<form enctype='multipart/form-data' name="purchase" action='process-edit.php' method='post' onsubmit='return validateform();'>
...
<tr>
<td colspan="3"><center><b>Edit User Details Form</b></center></td>
</tr>
<tr>
<td width ="9%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="30%"><font face="Verdana" size="2">Customer Name</td>
<input type=hidden name='id' id="id" value="<?php echo $row['id']?>">
<td><input type=text name='CustomerName' id="CustomerName" value="<?php echo $row['Customer_Name']?>"></td>
</tr>
<tr>
<td width ="9%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="30%"><font face="Verdana" size="2">Address</td>
<td><input type=text name='Address' id="Address" value="<?php echo $row['Address']?>"></td></td>
</tr>
<tr>
<td width ="9%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width="30%"><font face="Verdana" size="2">NIN</td>
<td><input type=text name='NIN' id="NIN" value="<?php echo $row['NIN']?>"></td>
</tr>
<tr>
<td width ="9%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width="30%"><font face="Verdana" size="2">Purchased Number</td>
<td><input type=text name='RequstedNumber' id="RequstedNumber" maxlength="7" value="<?php echo $row['Requested_Number']?>"></td>
</tr>
<!-- Row starts here -->
<tr><td width ="9%">
...
<td  width="469" >
<font face="Verdana"><input type=text name='receipt_no' id="receipt_no" value="<?php echo $row['receipt_no']?>"></td></tr>  <!-- A row end -->
...
<option value="<?php echo $row['sales_channel']?>" ><?php echo $row['sales_channel']?>
...
<td  width="469" >
<font face="Verdana"><input type=text name='DOB' id="DOB" value="<?php echo $row['DOB']?>" >
...
<option value="<?php echo $row['reg_medium']?>"><?php echo $row['reg_medium']?>
...
<tr>
<td width ="9%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width="30%"><font face="Verdana" size="2">Location</td>
