...
<head>
	<title>Roaming Request Table</title>
...
<div id="main">
<form enctype='multipart/form-data' action='roaming_report.php' method='post' >
...
if (isset($_GET['pageno'])) {
  $pageno = $_GET['pageno']; 
    ...
    $pageno = 1;
             ...
             $query = "SELECT count(*) FROM roaming";
 ...
 $cugquery = "SELECT * FROM  roaming order by date_req DESC $limit";
 $queryresult = mysql_query($cugquery);
  ...
  $i = 0;
   while($data = mysql_fetch_array($queryresult)){
      ...
      <tr><td colspan="10" bgcolor="#B5CBEF" height="25" width="737" background="../login/tile_sub.gif"><p align="center"><font face="Verdana" size="2">
		</tbody>
</table>
