...
$id = $_GET['id'];
$query = "select * from sim_replacement where id = $id";
...
<br/>
<br/>
<form enctype='multipart/form-data' action='edit_sim_proccess.php' method='post' onsubmit='return validateform();'>
...
<td width ="65%"><input type=text name='Customername' id='Customername' value="<?php echo $row['Customer_Name']?>"></td>
</tr>
<tr>
<td width ="10%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="25%"><font face="Verdana" size="2"> Address</td>
<td width ="65%"><input type=text name='Address' id='Address' value="<?php echo $row['Address']?>" ></td>
</tr>
<tr>
<td width ="10%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="25%"><font face="Verdana" size="2"> New Sim Number</td>
<td width ="65%"><input type=text name='newsim' id='newsim' value="<?php echo $row['new_sim']?>"></td>
</tr>
<tr>
<td width ="10%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="25%"><font face="Verdana" size="2"> Old Sim Number</td>
<td width ="65%"><input type=text name='oldsim' id='oldsim' maxlength="7" value="<?php echo $row['lost_sim']?>"></td>
</tr>
<tr>
<td width ="10%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="25%"><font face="Verdana" size="2"> Date Lost</td>
<td width ="65%">
<font face="Verdana"><font face="Verdana" size="2" color="black"><?php echo $row['date_lost']?>
</td>
</tr>
<tr>
<td width ="10%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="25%"><font face="Verdana" size="2">Reference No1.</td>
<td width ="65%"><font face="Verdana" size="2" color="black"><?php echo $row['ref_No1']?></td>
</tr>
<tr>
<td width ="10%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="25%"><font face="Verdana" size="2">Reference No2.</td>
<td width ="65%"><font face="Verdana" size="2" color="black"><?php echo $row['ref_No2']?></td>
</tr>
<tr>
<td width ="10%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width ="25%"><font face="Verdana" size="2">Reference No3.</td>
<td width ="65%"><font face="Verdana" size="2" color="black"><?php echo $row['ref_No3']?></td>
</tr>
<tr><td colspan="3">
