...
?>
<form enctype='multipart/form-data' name='loginForm' action='edit-exec.php' method='post'>
<table border="1" cellspacing="1" style="border-collapse: collapse" bordercolor="#000066" width="95%" cellpadding="5">

<?php
  include ("../Config/db.inc.php");//database connection
 
  $id = $_GET["id"];
            
  $order = "SELECT * FROM members where member_id ='$id'";
...
<td  width="469" >
<input type="hidden" id="id" name="id" value="<? echo "$row[member_id]" ?>" />
<font face="Verdana"><input type=text name='fname' value="<? echo "$row[firstname]" ?> "/></td></tr><tr><td  width="55" >
<img border="0" src="../images/bc_new.gif" width="28" height="28"></td><td  width="189" >
<font face="Verdana" size="2">Last Name</td>
<td width="469" >
<font face="Verdana"><input type=text name='lname' value="<? echo "$row[lastname]" ?> " /></td></tr><tr><td  width="55" >
<img border="0" src="../images/bc_new.gif" width="28" height="28"></td><td  width="189" >
<font face="Verdana" size="2">Username</td>
<td  width="469" >
<font face="Verdana"><input type=text name='login' value="<? echo "$row[login]" ?> "/></td></tr><tr><td >
<img border="0" src="../images/bc_new.gif" width="28" height="28"></td><td  width="189" >
...
<td width="469" >
<font face="Verdana"><input type=password name='cpassword'></td>
</tr><tr><td  width="55" >
<img border="0" src="../images/bc_new.gif" width="28" height="28"></td><td  width="189" >
<font face="Verdana" size="2">Department</td>
<td  width="469" >
<font face="Verdana"><select name='Department'>
<option value='<? echo "$row[permission]" ?>' style="visibility:hidden;"><? echo "$row[permission]" ?>
...
<p align="center"><font face="Verdana" size="2"><input type=submit value='Edit User'>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<input type=reset value='Cancel'></font></td></tr>
</table></form> 
	    </div>
</div>
