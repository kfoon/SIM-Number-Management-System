...
<br/>
<br/>
<form enctype='multipart/form-data' name="numchange" action='process-request.php' method='post' onsubmit='return validateform();'>
...
<tr>
<td colspan="3"><center><b>Choose Number Request Form</b></center></td>
</tr>
<tr>
...
<tr>
<td width ="9%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width="30%"><font face="Verdana" size="2">Existing Mobile Number</td>
<td><input type=text name='ExistingNumber' id="ExistingNumber" maxlength="7"></td>
</tr>
<tr>
<td width ="9%"><img src = "../images/bc_new.gif" alt= "image"/></td>
<td width="30%"><font face="Verdana" size="2">Requested Mobile Number</td>
