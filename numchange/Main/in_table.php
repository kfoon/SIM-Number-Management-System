...
<div id="main">
<form enctype='multipart/form-data' action='in_report.php' method='post'>
...
if (isset($_GET['pageno'])) {
 ...
 $cugquery = "SELECT * FROM in_request ORDER BY date $limit";
 $queryresult = mysql_query($cugquery);
  ...
  $i = 0;
   while($data = mysql_fetch_array($queryresult)){
      ...
      <tr><td colspan="9" bgcolor="#B5CBEF" height="25" width="737" background="../images/tile_sub.gif"><p align="center"><font face="Verdana" size="2">
		</tbody>
</table>
