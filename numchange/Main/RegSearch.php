...
$search_value = $_GET['search_value'];
        ...
        $cugquery= "select * from register where $search_field LIKE '%$search_value%' ORDER BY date DESC, time DESC ";
	}else{
...
<div id="main">
		<form action="RegSearch.php">
			<fieldset>
			Search Field:<select name="search_field" id="search_field">
			<option value="Customer_Name">Customer Name</option>
			<option value="Requested_Number">Mobile No.</option>
...
<?php
  ...
  $queryresult = mysql_query($cugquery);
   ...
   while($data = mysql_fetch_array($queryresult)){
      ...
      echo("<tr><td><a href='edit_details.php?id=$data[id]' style=text-decoration:none> <img src ='../images/128px-User.svg.png' style='border:0px'></img></a>
